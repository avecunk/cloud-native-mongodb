...
using MongoDB.Bson;
    ...
    public class ClientWriter {
        ...
        { 
            ...
            ApplicationName = "MongoDB-Client-C#-Writer",
        ...
        public void Insert(string db, string collection, BsonDocument document) {
        ...
        public void InsertAsync(string db, string collection, BsonDocument document) {
            var _db = _client.GetDatabase(db);
            if (_db != null) {
                var _collection = _db.GetCollection<BsonDocument>(collection);
                Task task = _collection.InsertOneAsync(document);                
            }
        }
    }
}